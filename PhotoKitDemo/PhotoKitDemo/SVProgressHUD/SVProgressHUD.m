...
+ (void)showWithStatus:(NSString*)status maskType:(SVProgressHUDMaskType)maskType {
    ...
    [self performSelector:@selector(autoDismiss) withObject:self afterDelay:60];
}
...
- (id)initWithFrame:(CGRect)frame {
    ...
    if ((self = [super initWithFrame:frame])) {
        ...
        SVProgressHUDBackgroundColor = [UIColor colorWithWhite:0.1 alpha:0.8];//[UIColor whiteColor];
